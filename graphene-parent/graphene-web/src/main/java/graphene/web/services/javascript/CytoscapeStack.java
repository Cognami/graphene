...
public class CytoscapeStack implements JavaScriptStack {
	...
	public CytoscapeStack(@Symbol(JQuerySymbolConstants.USE_MINIFIED_JS) final boolean minified,
		...
		javaScriptStack = F.flow("context:core/js/libs/cytoscape.js-2.3.9/cytoscape.js",
		...
		).append("context:core/js/t5/T5CytoscapeGraph.js").map(pathToAsset).toList();

		final Mapper<String, StylesheetLink> pathToStylesheetLink = F.combine(pathToAsset,
				JQueryUtils.assetToStylesheetLink);

		cssStack = F.flow("context:core/css/cytoscapeT5.css"
