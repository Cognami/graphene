...
public interface G_DataAccess {
  ...
  graphene.model.idl.G_TransactionResults getAllTransactions(graphene.model.idl.G_EntityQuery q) throws org.apache.avro.AvroRemoteException;
  java.lang.String saveObject(java.lang.Object g, java.lang.String id, java.lang.String indexName, java.lang.String type, boolean useDelay) throws org.apache.avro.AvroRemoteException;
  /** Moved from GenericDAO (non IDL) */
  long count(graphene.model.idl.G_EntityQuery q) throws org.apache.avro.AvroRemoteException;
  /** Moved from GenericDAO (non IDL) */
  graphene.model.idl.G_SearchResults getAll(long offset, long maxResults) throws org.apache.avro.AvroRemoteException;
  ...
  boolean performCallback(long offset, long maxResults, graphene.model.idl.G_CallBack cb, graphene.model.idl.G_EntityQuery q) throws org.apache.avro.AvroRemoteException;
  ...
  double getReadiness() throws org.apache.avro.AvroRemoteException;
  /** * 
	 * @return true if this DAO is ready to be queried. */
  boolean isReady() throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends G_DataAccess {
    ...
    /** Moved from GenericDAO (non IDL) */
    void search(graphene.model.idl.G_EntityQuery pq, org.apache.avro.ipc.Callback<graphene.model.idl.G_SearchResults> callback) throws java.io.IOException;
    /** Returns the property descriptors that can be used for a Search. This is normally used to populate the Advanced 
	 Search UI, providing a list of various sub-sets of the data (by type) and the valid search options for each.
    ...
    void getAllTransactions(graphene.model.idl.G_EntityQuery q, org.apache.avro.ipc.Callback<graphene.model.idl.G_TransactionResults> callback) throws java.io.IOException;
    void saveObject(java.lang.Object g, java.lang.String id, java.lang.String indexName, java.lang.String type, boolean useDelay, org.apache.avro.ipc.Callback<java.lang.String> callback) throws java.io.IOException;
    /** Moved from GenericDAO (non IDL) */
    void count(graphene.model.idl.G_EntityQuery q, org.apache.avro.ipc.Callback<java.lang.Long> callback) throws java.io.IOException;
    /** Moved from GenericDAO (non IDL) */
    void getAll(long offset, long maxResults, org.apache.avro.ipc.Callback<graphene.model.idl.G_SearchResults> callback) throws java.io.IOException;
    /** * Within this method, the callback cb will be executed, usually on each
	 * result the implementation finds. The implementation may choose to respect
	 * the G_EntityQuery q. If maxResults is set to 0, that is usually understood
	 * to mean that there is no upper bound to the number of results (aka All
	 ...
	 * @param q
	 * @return true if the callback succeeded, or did not find any errors. */
    void performCallback(long offset, long maxResults, graphene.model.idl.G_CallBack cb, graphene.model.idl.G_EntityQuery q, org.apache.avro.ipc.Callback<java.lang.Boolean> callback) throws java.io.IOException;
    /** * This method is an expansion of the isReady system status. Individual
	 * implementations can declare what their readiness state is, and methods
	 * calling those implementations can decide whether the system is ready
	 * enough the be queried. This is good for multi layered DAOs, such as those
	 ...
	 * 
	 * @return a value between 0 (not ready) and 1 (fully operational) */
    void getReadiness(org.apache.avro.ipc.Callback<java.lang.Double> callback) throws java.io.IOException;
    /** * 
	 * @return true if this DAO is ready to be queried. */
    void isReady(org.apache.avro.ipc.Callback<java.lang.Boolean> callback) throws java.io.IOException;
    /** * Allows end user implementations to record the readiness of the service,
	 * for example if a procedure fails we may set the service to not ready, or
	 * a larger service can cause this service to be available or unavailable
	 * depending on it's settings.
	 * 
	 * @param b */
    void setReady(boolean b, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
  }
}